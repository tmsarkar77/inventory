  <!-- Modal -->
  <div class="modal fade" id="update1-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 p-1">
                        ...
                        <br/>
                        <img class="img-fluid" width="80px" id="oldImg" src="{{asset('/assets/images/default.jpg')}}"/>
                        <br/>
